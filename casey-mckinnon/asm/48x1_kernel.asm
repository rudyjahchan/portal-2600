...
casey_pf48x1_loop_line1
	...
	lda aux3 		;3
	beq casey_pf48x1_loop_line2 	;2/3
	sleep 2

	dey
	cpy #255
	bne casey_pf48x1_loop_line1		;2/3

	jmp casey_pf48x1_codeend

casey_pf48x1_loop_line2
	...
	dey
	;cmp #255
	bpl casey_pf48x1_loop_line1		;2/3

casey_pf48x1_codeend
 ;echo "critical code in 48x1 is ",(casey_pf48x1_codeend-casey_pf48x1_loop), " bytes long."
