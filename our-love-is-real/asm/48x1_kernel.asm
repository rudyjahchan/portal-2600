...
love_pf48x1_loop_line1
	...
	lda aux3 		;3
	beq love_pf48x1_loop_line2 	;2/3
	sleep 2

	dey
	cpy #255
	bne love_pf48x1_loop_line1		;2/3

	jmp love_pf48x1_codeend

love_pf48x1_loop_line2
	...
	dey
	;cmp #255
	bpl love_pf48x1_loop_line1		;2/3

love_pf48x1_codeend
 ;echo "critical code in 48x1 is ",(love_pf48x1_codeend-love_pf48x1_loop), " bytes long."
