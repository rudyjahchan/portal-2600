...
cake_pf48x1_loop_line1
	...
	lda aux3 		;3
	beq cake_pf48x1_loop_line2 	;2/3
	sleep 2

	dey
	cpy #255
	bne cake_pf48x1_loop_line1		;2/3

	jmp cake_pf48x1_codeend

cake_pf48x1_loop_line2
	...
	dey
	;cmp #255
	bpl cake_pf48x1_loop_line1		;2/3

cake_pf48x1_codeend
 ;echo "critical code in 48x1 is ",(cake_pf48x1_codeend-cake_pf48x1_loop), " bytes long."
